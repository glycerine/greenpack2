...
func generate(f *parse.FileSet, mode gen.Method, cfg *cfg.GreenConfig) (*bytes.Buffer, *bytes.Buffer, error) {
	...
	myImports = append(myImports, "github.com/glycerine/greenpack2/msgp")
	...
	if mode&gen.Test == gen.Test {
		...
		if mode&(gen.Encode|gen.Decode) != 0 {
			writeImportHeader(testbuf, "bytes", "github.com/glycerine/greenpack2/msgp", "testing")
		} else {
			writeImportHeader(testbuf, "github.com/glycerine/greenpack2/msgp", "testing")
		}
		testwr = testbuf
	}
...
func writePkgHeader(b *bytes.Buffer, name string) {
	b.WriteString("// Code generated by GREENPACK (github.com/glycerine/greenpack2). DO NOT EDIT.\n\n")
